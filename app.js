...
const i18n = {
  pt: {
    nav_home: "Início",
    top_right: "Atendimento online e presencial",
    hero_focus: "Advocacia Previdenciária e Tributária",
    btn_signature: "Assinatura",
    sig_h2: "Assinatura",
    sig_p: "Solicite a assinatura profissional por WhatsApp ou e-mail e eu envio o arquivo e instruções de uso.",
    sig_btn_wa: "Pedir no WhatsApp",
    sig_btn_email: "Pedir por e-mail",
    nav_about: "Quem Sou",
    nav_edu: "Atuação",
    nav_exp: "Serviços",
    nav_contact: "Contato",
    ...
    nav_attend: "Atendimento",
    nav_content: "Conteúdos",
    nav_schedule: "Agendamento",
    btn_whats: "Falar no WhatsApp",
    hero_lead: "Atuação técnica e estratégica com foco em segurança jurídica, análise individualizada e soluções responsáveis.",
  ...
  en: {
    nav_home: "Home",
    top_right: "Online and in-person service",
    hero_focus: "Social Security & Tax Law Practice",
    btn_signature: "Signature",
    sig_h2: "Signature",
    sig_p: "Request the professional signature via WhatsApp or email and I will send the file and usage instructions.",
    sig_btn_wa: "Request on WhatsApp",
    sig_btn_email: "Request by email",
    nav_about: "About",
    nav_edu: "Education",
    nav_exp: "Experience",
    nav_contact: "Contact",
    nav_atuacao: "Practice",
    nav_services: "Services",
    nav_attend: "Appointments",
    nav_content: "Content",
    nav_schedule: "Schedule",
    btn_whats: "WhatsApp",
    hero_lead: "Technical and strategic practice focused on legal certainty, individualized analysis and responsible solutions.",
    btn_pdf: "Save as PDF",
  ...
  es: {
    ...
    nav_atuacao: "Actuación",
    nav_services: "Servicios",
    nav_attend: "Atención",
    nav_content: "Contenidos",
    nav_schedule: "Agenda",
    btn_whats: "WhatsApp",
    hero_lead: "Actuación técnica y estratégica con enfoque en seguridad jurídica, análisis individualizado y soluciones responsables.",
...
function applyLanguage(lang){
  ...
  setText("nav_atuacao", dict.nav_atuacao);
  setText("nav_services", dict.nav_services);
  setText("nav_attend", dict.nav_attend);
  setText("nav_content", dict.nav_content);
  setText("nav_schedule", dict.nav_schedule);
  setText("btn_whats", dict.btn_whats);
  setText("hero_lead", dict.hero_lead);
